...
//		USART_OUT(USART1,"MAADR5 = %d\r\n", enc28j60Read(MAADR5));
//		USART_OUT(USART1,"MAADR4 = %d\r\n", enc28j60Read(MAADR4));
//		USART_OUT(USART1,"MAADR3 = %d\r\n", enc28j60Read(MAADR3));
//		USART_OUT(USART1,"MAADR2 = %d\r\n", enc28j60Read(MAADR2));
//		USART_OUT(USART1,"MAADR1 = %d\r\n", enc28j60Read(MAADR1));
//		USART_OUT(USART1,"MAADR0 = %d\r\n", enc28j60Read(MAADR0));
//	}
	//配置PHY为全双工  LEDB为拉电流
